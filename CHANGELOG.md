...
- Add "Copy Markdown" and "Save As..." actions directly to in-page status cards.
- Add SVG chevron icons and instant localized tooltip for in-page card collapse toggle.

### Changed

- Eliminate full-document DOM rescans during message extraction and merge assistant poll clones for improved performance.
...
- Track generated-character progress when Codex renders Markdown in a
  CodeMirror document.
- Preserve Markdown line breaks when extracting Codex CodeMirror output.
